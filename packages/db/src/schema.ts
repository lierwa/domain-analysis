...
export const collectionPlans = sqliteTable(
  "collection_plans",
  {
    ...
    platforms: text("platforms", { mode: "json" }).notNull().default('["reddit"]'),
    browserMode: text("browser_mode").notNull().default("local_profile"),
    maxScrollsPerPlatform: integer("max_scrolls_per_platform").notNull().default(5),
    maxItemsPerPlatform: integer("max_items_per_platform").notNull().default(50),
...
export const crawlTasks = sqliteTable(
  "crawl_tasks",
  {
    ...
    duplicateCount: integer("duplicate_count").notNull().default(0),
    errorMessage: text("error_message"),
    pagesCollected: integer("pages_collected").notNull().default(0),
    lastCursor: text("last_cursor"),
    stopReason: text("stop_reason"),
    lastRequestAt: text("last_request_at"),
    nextRequestAt: text("next_request_at"),
    startedAt: text("started_at"),
    finishedAt: text("finished_at"),
